...
| `terrace/ta2a*.py` | T-A2A two-hop chain: planning, dispatch, packing, differentiable seam | **Validated bit-exact** (guarded by the repo's 280 CPU tests; end-to-end measured only on a flat supernode — see the criterion) |
...
| `tests/` | 280 tests, pure CPU (no NPU needed) | All green |
